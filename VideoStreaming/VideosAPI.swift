...
protocol VideosAPIProtocol {
    func fetchVideoList(byGameId gameId: String, completion: @escaping (Bool, [Video], APIError?) -> Void)
    func fetchVideoList(byUserId userId: String, completion: @escaping (Bool, [Video], APIError?) -> Void)
}
