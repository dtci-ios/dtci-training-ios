...
protocol VideosAPIProtocol {
    func fetchVideoList(byGameId gameId: String, completion: @escaping (Swift.Result<[Video],APIError>) -> Void)
    func fetchVideoList(byUserId userId: String, completion: @escaping (Swift.Result<[Video],APIError>) -> Void)
}
